...
/* Chat Header - Yellow Modern Style */
.chat-header {
   background: #F5D547;
   color: #2D3748;
   display: flex;
...
.agent-message p:not(:last-child) {
   margin-bottom: 10px;
}
...
<button class="chat-toggle" onclick="toggleChat()" id="chatToggleBtn">
   <svg id="openIcon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
      <path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path>
   </svg>
   <span id="openText">Chat with Alex</span>
   <svg id="closeIcon" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="display: none;">
...
<div class="chat-box" id="chatBox">
   <div class="chat-header">
      ...
      <div class="chat-header-info">
         ...
         <span class="chat-header-status">Electronics Buy-Back Expert • Reno, NV Since 2008</span>
      </div>
   </div>
      ...
      <div class="chat-welcome" id="chatWelcome">
         <div class="agent-intro">
            ...
            <div class="agent-message">
               <p><strong>Alex</strong> • Electronics Buy-Back Expert • Reno, NV Since 2008</p>
               <p>Good morning! I'm Alex ☀️ Ready to help you sell your device!</p>
               <p>📦 FREE shipping label - we buy your electronics!</p>
               <p>⭐ Family-owned & BBB accredited - top prices, fast payment since 2008</p>
               <p>What device would you like to sell?</p>
            </div>
         </div>
      </div>

      <deep-chat
         connect='{"url": "https://www.sellmylaptops.com/chat.php", "method": "POST"}'
         textInput='{"placeholder": {"text": "What device would you like to sell?"}}'

      ></deep-chat>
   </div>

   <div class="quick-actions">
      <a href="https://www.sellmylaptops.com/sell?utm_source=ai_chat&utm_medium=quick_link&utm_campaign=get_quote" target="_blank" class="quick-action">
         💸 Get Quote
      </a>
      <a href="https://www.sellmylaptops.com/how-it-works?utm_source=ai_chat&utm_medium=quick_link&utm_campaign=how_it_works" target="_blank" class="quick-action">
         📦 How It Works
      </a>
      <a href="https://www.sellmylaptops.com/categories?utm_source=ai_chat&utm_medium=quick_link&utm_campaign=categories" target="_blank" class="quick-action">
         💻 Categories
      </a>
      <a href="https://www.sellmylaptops.com/contact-us?utm_source=ai_chat&utm_medium=quick_link&utm_campaign=contact" target="_blank" class="quick-action">
         📞 Contact Us
      </a>
   </div>
</div>
...
function toggleChat() {
   ...
   openText.style.display = isOpen ? 'inline' : 'none';
   ...
   if (!isOpen) {
      setTimeout(() => {
         document.getElementById('chatWelcome').classList.add('hide');
      }, 5000);
   }
}
</script>
...
<script src="<?=SITE_URL?>assets/js/common.js?t=<?=rand(0000,9999)?>"></script>
...
(function ($) {
   $(function () {
       ...
       //For social signup/signin
       if($social_login=='1') {
           /*if($social_login_option=="g_f" || $social_login_option=="g") { ?>
               //For Google
               $('.s_google_auth').oauthpopup({
                   path: '<?=SITE_URL?>social/social.php?google',
                   width:500,
                   height:650,
               });
           <?php
...
<script src="<?=SITE_URL?>assets/js/sml-chat-widget.js"></script>
<?=$before_body_js_code?>
...
<!-- Enhanced AI Chat UTM Tracking -->
<!--
<script>
document.addEventListener('DOMContentLoaded', function() {
   // Enhanced UTM tracking for AI Chat
   const urlParams = new URLSearchParams(window.location.search);
   const isFromChat = urlParams.get('utm_source') === 'ai_chat';
  
   // Track if user arrived from chat
   if (isFromChat) {
       console.log('User arrived from AI Chat with UTMs:', {
