<section class="have_question_banner" <?=$section_bg_styles?>>
    <?=$section_bg_video?>
    <div class="container">
        <div class="col-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
            ...
            <?php
            if($home_page_settings_data['button_text'] && $home_page_settings_data['button_url']) { ?>
                <div class="block heading text-center">
                    <?php
                    if($home_page_settings_data['button_url'] == '{$contact_us_form}') { ?>
                        <a href="javascript:void(0);" data-toggle="modal" data-target="#contactusForm" class="btn btn-primary btn-lg mr-0 my-2"><?=$home_page_settings_data['button_text']?></a>
                    <?php
                    } else { ?>
